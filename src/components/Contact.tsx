...
const Contact = () => {
  ...
  const socialLinks = [
    ...
    { icon: Twitter, href: "https://twitter.com", label: "Twitter", color: "hover:text-accent" },
    { icon: Mail, href: "mailto:muhammad.faizan@example.com", label: "Email", color: "hover:text-primary" }
  ];

  const contactInfo = [
    { icon: Mail, text: "muhammad.faizan@example.com", color: "text-primary" },
    { icon: Phone, text: "+1 (555) 123-4567", color: "text-secondary" },
