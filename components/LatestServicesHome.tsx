        ...
        <div className="row">
          <div className="col-lg-6">
            <div className="service-card-v2 tmponhover tmp-scroll-trigger tmp-fade-in animation-order-1">
              ...
              <p className="service-para">Business consulting consultants provide expert advice and guida the a businesses to help theme their performance efficiency</p>
            </div>
            <div className="service-card-v2 tmponhover tmp-scroll-trigger tmp-fade-in animation-order-2">
              ...
              <p className="service-para">My work is driven by the belief that thoughtful design and strategic planning can empower brands, transform businesses</p>
            </div>
            <div className="service-card-v2 tmponhover tmp-scroll-trigger tmp-fade-in animation-order-3">
              ...
              <p className="service-para">In this portfolio, you’ll find a curated selection of projects that highlight my skills in [Main Areas, e.g., responsive web design</p>
            </div>
          </div>
          <div className="col-lg-6">
